...
Please write a catchy tag line for a pair of shoes
...
I need to generate some sample book titles, authors, ratings, and price information for non-fiction books. 

Could you please generate some data in the JSON format?
